...
function Navbar() {
  ...
  const getActiveClass = ({ isActive }) =>
    isActive
      ? `text-center p-3 mt-6 ${isToggled ? "bg-black text-white" : "bg-white text-black"} hover:bg-gray-800`
  ...
  return (
    <nav
      className={`h-[100px] flex fixed w-full z-10 top-0 justify-around items-center font-poppins font-medium shadow-custom-shadow ${
    ...
    >
      ...
      <div
        ...
        className={`fixed h-full w-screen lg:hidden 
          bg-black/20 backdrop-blur-sm top-0 right-0
      ...
      >
        ...
        >
          ...
          <ul className="uppercase flex flex-col gap-10 text-gray-500 items-center">
            ...
            <li>
              <NavLink to="/shop" className={getActiveClass} onClick={() => setMenuOpen(false)}>
                Shop
              </NavLink>
            </li>
            {user && (
              <li>
                <NavLink to="/cart" className={getActiveClass} onClick={() => setMenuOpen(false)}>
                  Cart
                </NavLink>
              </li>
            )}
      ...
      <ul className="uppercase hidden tablet:flex gap-10 text-gray-500 items-center">
        ...
        {user && (
          <li>
            <NavLink to="/cart" className={getActiveClass}>Cart</NavLink>
          </li>
        )}
        {!user ? (
          <li>
            <NavLink to="/signup" className={getActiveClass}>Sign Up</NavLink>
          </li>
        ) : (
          <li>
