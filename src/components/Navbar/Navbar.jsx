  ...
  return (
    <div>
      <nav
        ...
        }  transition-all duration-300 ease-in-out flex justify-between items-center px-5`}
      >
        {/* Logo Section */}
        <div className="logo">
        ...
        <ul className="flex gap-6 items-center">
          ...
          <li className="cursor-pointer text-xl" onClick={toggleThemeHandler}>
