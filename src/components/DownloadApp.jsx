    ...
    <div   className={`  ${
      ...
      <section className="max-w-[1483px] mx-auto grid md:grid-cols-2 xs:grid-cols-1 gap-6 md:gap-12 md:p-24 xs:p-8 items-center">
        ...
        <div className="left-text">
          <h1 className="capitalize font-poppins font-bold md:text-4xl xs:text-4xl leading-tight">
            <span className="block">Download App &</span>
            <span>Get the Voucher</span>
          </h1>
          <p className="text-[#7C7C7C] mt-10">
            <span className="block">Get 30% off for first transaction using</span>
