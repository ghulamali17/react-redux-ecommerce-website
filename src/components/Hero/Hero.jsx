  ...
  return (
    ...
    >
      {/* <section className="hero relative max-w-[1300px] mx-auto bg-[#F4F6F5]  rounded-[30px] border border-black">
        <img src="./assets/star.svg" className="absolute top-[80%] left-[60%]" alt="star icon" />
        <img src="./assets/star.svg" className="absolute top-[73%] left-[93%]" alt="star icon" />
        <img src="./assets/star.svg" className="absolute top-[10%] left-[60%]" alt="star icon" />
        <img src="./assets/star.svg" className="absolute top-[15%] sm:top-[20%] sm:left-[88%] left-[93%]" alt="star icon" />
