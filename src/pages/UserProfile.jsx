...
function UserProfile() {
  ...
  return (
    <div>
      <section
        className={`mt-[100px] py-8 antialiased dark:bg-gray-900 md:py-8 ${
      ...
      >
        ...
        >
          <nav className="mb-4 flex" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              <li className="inline-flex items-center">
                <button onClick={()=>navigate("/")}  className={`inline-flex items-center text-sm font-medium  hover:text-primary-600 dark:text-gray-400 dark:hover:text-white ${
                    isToggled ? " text-gray-700" : " text-white"
                  } transition-all duration-300 ease-in-out`}>
                  <svg
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className={`ms-1 text-sm font-medium  hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2 ${
                      isToggled
                        ? " text-gray-700"
                        : " text-white"
                    } transition-all duration-300 ease-in-out`}
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span
                    className={`ms-1 text-sm font-medium  dark:text-gray-400 md:ms-2${
                      isToggled
                        ? " text-gray-500 "
                        : " text-white"
                    } transition-all duration-300 ease-in-out`}
          ...
          <h2
            className={`mb-4 text-xl font-semibold  dark:text-white sm:text-2xl md:mb-6 ${
          ...
          <div className="grid grid-cols-2 gap-6 border-b border-t border-gray-200 py-4 dark:border-gray-700 md:py-8 lg:grid-cols-4 xl:gap-16">
            <div>
              ...
              <h3
                className={`mb-2  ${
                  isToggled ? " text-gray-500" : " text-white"
                } transition-all duration-300 ease-in-out`}
              >
                Orders made
              </h3>
          ...
          <div className="py-4 md:py-8">
            <div className="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
              <div className="space-y-4">
                <div className="flex space-x-4">
                  ...
                  <div>
                    <h2
                      className={`flex items-center text-xl font-bold leading-none sm:text-2xl ${
                        isToggled ? "text-gray-900" : "text-white"
                      }`}
                    >
                ...
                <dl>
                  ...
                  <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
                    ...
                    123 Road, Gulshan-e-Iqbal, Karachi, Sindh, 75290, Pakistan
                  </dd>
                </dl>
                <dl>
                  <dt
                ...
                <dl>
                  ...
                  <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
                    ...
                    >
                     ...
                     Block 7, Clifton, Karachi, Sindh, 75600, Pakistan
                  </dd>
                </dl>
                  ...
                  <dd className="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
                    ...
                    <div>
                      <div className="text-sm">
                        <p
                          className={`"mb-0.5 font-medium  dark:text-white ${
                            isToggled ? "text-gray-900" : "text-white"
                          }`}
                        >
                          Visa ending in 7658
            ...
            <button
              ...
              className={`inline-flex w-full items-center justify-center rounded-lg px-5 py-2.5 
                text-sm font-medium focus:outline-none focus:ring-4 sm:w-auto 
                ${
                  isToggled
                    ? " text-gray-900 hover:bg-gray-100 focus:ring-gray-300"
                    : " text-white hover:bg-gray-800 focus:ring-gray-600"
                } 
                transition-all duration-300 ease-in-out`}
            >
              <svg
